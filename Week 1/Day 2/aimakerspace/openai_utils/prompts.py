...
class BasePrompt:
    def __init__(self, prompt):
        ...
        """
        self.prompt = prompt
        # This line compiles a regular expression pattern
        # The pattern matches any text within curly braces {}
        # It captures the content inside the braces, excluding the braces themselves
        # This is used to find placeholders in the prompt string for later substitution
    ...
    def format_prompt(self, **kwargs):
        ...
        """
        # Find all placeholders in the prompt string
        matches = self._pattern.findall(self.prompt)
        
        # Format the prompt by replacing placeholders with provided values
        # If a value is not provided in kwargs, use an empty string as default
